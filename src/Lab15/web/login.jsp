...
<%@ page import="com.example.LoginServlet" %>
<!DOCTYPE html>
<html lang="ru">
<head>
...
<h1 class="text-3xl font-bold mb-4">Вход в систему</h1>
<form action="LoginServlet" method="GET" class="bg-white p-4 rounded shadow">
    <div class="mb-4">
        <label for="username" class="block text-gray-600">Логин:</label>
    ...
    <div class="mb-4">
        ...
        <input type="password" name="password" id="password" class="w-full p-2 border border-gray-300 rounded focus:outline-none focus:border-blue-400">
    </div>
